...
(function (factory) {
    ...
    $.widget('blueimpUI.fileupload', $.blueimpIP.fileupload, {
        ...
        options: {
            ...
            // Callback for successful uploads:
                ...
                $('#uploadFileListing > li').each(function (index) {
                    ...
                    $(this).find(".image").find('img').attr("id","image" + index);
                           
                });
                var listing =  $('#uploadFileListing').html();
              
                if (listing.length == 0)
                {                        
                    if  ($('#phototabs #tabs-1').hasClass('photobin'))
                        $('#phototabs #tabs-1').removeClass('photobin');
                    if  (!$('#phototabs #tabs-1').hasClass('empty'))
                        $('#phototabs #tabs-1').addClass('empty');					
					$('#instr').hide();
					$('#emptyinstr').show();
					$('#phototabs #tabs-1').show();
                                        
                     if  ($('#posttabs #tabs-2').hasClass('photobin'))
                        $('#posttabs #tabs-2').removeClass('photobin');
                    if  (!$('#posttabs #tabs-2').hasClass('empty'))
                        $('#posttabs #tabs-2').addClass('empty');					
					$('#instr').hide();
					$('#emptyinstr').show();
					$('#posttabs #tabs-2').show();
                }
                else
                {
                    if  ($('#phototabs #tabs-1').hasClass('empty'))
                        $('#phototabs #tabs-1').removeClass('empty');
                    if  (!$('#phototabs #tabs-1').hasClass('photobin'))
                        $('#phototabs #tabs-1').addClass('photobin');
					$('#emptyinstr').hide();
					$('#instr').show();
					$('#tabs-1').show();
                                        
                                        if  ($('#posttabs #tabs-2').hasClass('empty'))
                        $('#posttabs #tabs-2').removeClass('empty');
                    if  (!$('#posttabs #tabs-2').hasClass('photobin'))
                        $('#posttabs #tabs-2').addClass('photobin');
					$('#emptyinstr').hide();
					$('#instr').show();
					$('#tabs-1').show();
                }
        ...
        _destroyButtonBarEventHandlers: function () {
            this.element.find('.fileupload-buttonbar a')
        ...
        _destroyEventHandlers: function () {
            ...
            .undelegate('.cancel a', 'click.' + this.options.namespace)
            .undelegate('.pophint-delete a.delete', 'click.' + this.options.namespace);
