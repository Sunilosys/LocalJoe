...
*
* ** USAGE **
* In your Layout or View scripts, you can simply call minifyInlineScript
* in the same way that you used to call inlineScript. Here is an example:
*
echo $this->minifyInlineScript()
...
*
*/
class Zend_View_Helper_MinifyInlineScript extends Zend_View_Helper_InlineScript {
...
* @var string
*/
protected $_regKey = 'RC_View_Helper_MinifyInlineScript';

/**
* Return inlineScript object
*
* Returns inlineScript helper object; optionally, allows specifying a script
...
*/
public function minifyInlineScript($mode = Zend_View_Helper_InlineScript::FILE, $spec = null, $placement = 'APPEND', array $attrs = array(), $type = 'text/javascript') {
...
*
* @see Zend_View_Helper_InlineScript->toString()
